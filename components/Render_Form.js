...
export function RenderForm(props)
{
    ...
    const arr = [slots,courses,courses_name,category,course_option,class_nbr,faculty];
        ...
        <div className="flex">
            <table className="custom1">
                <tr>
                    ...
                    <td><input placeholder="Faculty" className="custom2 rounded py-1 px-2" onChange={(event)=>{setFaculty(event.target.value)}}></input></td>
                </tr>
            </table>
