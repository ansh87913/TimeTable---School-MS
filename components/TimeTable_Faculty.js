...
import { CreateCourseFaculty } from "./Create_course._Faculty";
import { CoursePageFaculty } from "./Course_Page_Faculty";

//Create a parent web page to distinguish between faculty and student
export function TimeTableFaculty(props)
{
    ...
    return(
        <div class="align">
            {<CreateCourseFaculty id={props.id}/>}
            <div>{<CoursePageFaculty id={props.id}/>}</div>
